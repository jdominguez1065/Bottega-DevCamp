...
//edads > 18 
//? console.log(valorSiVerdadero)
//: console.log(valorSiFalso)


//const edad = 17;
//const valorSiVerdadero = 'Tiene edad para sacarse el carné de conducir de motos pero no de coches.';
//const valorSiFalso = 'Tiene edad para sacarse el carné de conducir de coches y motos.';
...
console.log(saludos('Jorge'));

const saludoss = function (nombre) {
	return `Hola ${nombre}`
}

console.log(saludoss('Jorge'));


const saludosss = (nombre) => {
	return `Hola ${nombre}`
}

console.log(saludosss('Jorge'));
